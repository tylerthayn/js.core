(() => {
  ...
  var require_Define = __commonJS({
    "src/Object/Define.js"() {
      require_global();
      var dataDesc = /* @__PURE__ */ new Set(["configurable", "enumerable", "get", "set"]);
      var accDesc = /* @__PURE__ */ new Set(["configurable", "enumerable", "writable", "value"]);
      var _define = typeof Reflect !== "undefined" && Reflect.defineProperty ? Reflect.defineProperty : Object.defineProperty;
  ...
  var require_Type = __commonJS({
    "src/Object/Type.js"() {
      ...
      require_Define();
      require_From();
      Define(global, "Type", function Type2() {
        ...
        if (arguments.length == 2) {
          return Type2(arguments[0]).toLowerCase() === (typeof arguments[1] === "string" ? arguments[1] : Type2(arguments[1])).toLowerCase();
        }
        var type = Type2(arguments[0]);
        for (var i = 1; i < arguments.length; i++) {
          if (!Type2(arguments[0], arguments[i])) {
            return false;
          }
        }
        return true;
      ...
      Define(Object.prototype, "Each", function(nonEnumerable, cb) {
        ...
        if (Type(this, "Array")) {
          ...
          for (let i = 0; i < keys.length; i++) {
            if (cb(this[keys[i]], keys[i], this) === false) {
              return;
            }
          }
        }
  ...
  var require_Set = __commonJS({
    "src/Object/Set.js"() {
      ...
      Define(Object.prototype, "Set", function(path, value) {
        return this == null ? this : lodash.set(this, path, value);
      });
    }
  });
  ...
  // src/Array/DeleteAt.js
  var require_DeleteAt = __commonJS({
    "src/Array/DeleteAt.js"() {
      require_Define();
      Define(Array.prototype, "DeleteAt", function() {
        [...arguments].sort().reverse().forEach((arg) => {
          console.log(arg);
          this.splice(arg, 1);
        });
        return this;
  ...
  // src/Array/OmitAt.js
  var require_OmitAt = __commonJS({
    "src/Array/OmitAt.js"() {
      require_Define();
      Define(Array.prototype, "OmitAt", function() {
        let a = [], omitIndexes = [];
        for (let i2 = 0; i2 < arguments.length; i2++) {
          omitIndexes.push(arguments[i2]);
        }
        for (var i = 0; i < this.length; i++) {
  ...
  // src/String/AsAscii.js
  var require_AsAscii = __commonJS({
    "src/String/AsAscii.js"() {
      require_Define();
      Define(String.prototype, "AsAscii", function(test) {
        try {
          ...
          if (typeof Utilities === "object" && "base64Decode" in Utilities) {
            return Utilities.newBlob(Utilities.base64Decode(this, Utilities.Charset.UTF_8)).getDataAsString();
          }
        } catch (e) {
          if (typeof test !== "boolean" || test === false) {
  ...
  // src/String/AsBase64.js
  var require_AsBase64 = __commonJS({
    "src/String/AsBase64.js"() {
      require_Define();
      Define(String.prototype, "AsBase64", function(test) {
        try {
          ...
          if (typeof Utilities === "object" && "base64Encode" in Utilities) {
  ...
  // src/String/AsUrlMatch.js
  var require_AsUrlMatch = __commonJS({
    "src/String/AsUrlMatch.js"() {
      require_Define();
      function AsUrlMatch(t) {
        ...
        if (!r)
          return null;
        if (t = t.substr(r[0].length), e += r[1] === "*" ? "https?://" : r[1] + "://", r[1] !== "file") {
          if (!(r = /^(?:\*|(\*\.)?([^\/*]+))(?=\/)/.exec(t)))
            return null;
          t = t.substr(r[0].length), r[0] === "*" ? e += "[^/]+" : (r[1] && (e += "(?:[^/]+\\.)?"), e += n(r[2]));
        }
  ...
  var require_CamelCase = __commonJS({
    "src/String/CamelCase.js"() {
      require_Define();
      var preserveCamelCase = (a) => {
        let b = false, d = false, e = false;
        for (let f = 0; f < a.length; f++) {
          const g = a[f];
          b && /[a-zA-Z]/.test(g) && g.toUpperCase() === g ? (a = a.slice(0, f) + "-" + a.slice(f), b = false, e = d, d = true, f++) : d && e && /[a-zA-Z]/.test(g) && g.toLowerCase() === g ? (a = a.slice(0, f - 1) + "-" + a.slice(f - 1), e = d, d = false, b = true) : (b = g.toLowerCase() === g, e = d, d = g.toUpperCase() === g);
        }
        return a;
      };
      function camelCase(a, b) {
        b = Object.assign({ pascalCase: false }, b);
        const c = (e) => b.pascalCase ? e.charAt(0).toUpperCase() + e.slice(1) : e;
        if (a = Array.isArray(a) ? a.map((e) => e.trim()).filter((e) => e.length).join("-") : a.trim(), a.length === 0)
          return "";
        if (a.length === 1)
          return b.pascalCase ? a.toUpperCase() : a.toLowerCase();
        if (/^[a-z\d]+$/.test(a))
          return c(a);
        const d = a !== a.toLowerCase();
        return d && (a = preserveCamelCase(a)), a = a.replace(/^[_.\- ]+/, "").toLowerCase().replace(/[_.\- ]+(\w|$)/g, (e, f) => f.toUpperCase()), c(a);
      }
      function CamelCase() {
  ...
  var require_Hash = __commonJS({
    "src/String/Hash.js"() {
      ...
      function md5(M, r, D) {
        return r ? D ? rawHMACMD5(r, M) : hexHMACMD5(r, M) : D ? rawMD5(M) : hexMD5(M);
      }
      ...
      function rstrHMACMD5(r, d) {
        ...
        for (f[15] = i[15] = void 0, m.length > 16 && (m = binlMD5(m, 8 * r.length)), n = 0; n < 16; n += 1)
      ...
      function binToHex(a) {
        ...
        for (d = 0; d < 4 * a.length; d++)
          c += b.charAt(15 & a[d >> 2] >> 8 * (3 - d % 4) + 4) + b.charAt(15 & a[d >> 2] >> 8 * (3 - d % 4));
        return c;
      }
      function coreFunction(f) {
        var o, p, q, r, s, u, v, x, g = [], h = 1732584193, k = 4023233417, l = 2562383102, m = 271733878, n = 3285377520;
        for (v = 0; v < f.length; v += 16) {
          for (o = h, p = k, q = l, r = m, s = n, x = 0; 80 > x; x++)
            g[x] = 16 > x ? f[v + x] : cyclicShift(g[x - 3] ^ g[x - 8] ^ g[x - 14] ^ g[x - 16], 1), u = modPlus(modPlus(cyclicShift(h, 5), ft(x, k, l, m)), modPlus(modPlus(n, g[x]), kt(x))), n = m, m = l, l = cyclicShift(k, 30), k = h, h = u;
      ...
      function kt(a) {
        return 20 > a ? 1518500249 : 40 > a ? 1859775393 : 60 > a ? 2400959708 : 3395469782;
      }
  ...
  var require_Debug = __commonJS({
    "src/Functional/Debug.js"() {
      ...
      Define(global, "Debug", function(name, print) {
        let logger = typeof print === "undefined" ? function() {
        } : print == "json" ? logj : log;
        return function() {
  ...
  // src/Extensions/EventEmitter.js
  var require_EventEmitter = __commonJS({
    "src/Extensions/EventEmitter.js"() {
      ...
      Define(Object.Extensions, "EventEmitter", function(o) {
        ...
        var ReflectOwnKeys;
        R && typeof R.ownKeys == "function" ? ReflectOwnKeys = R.ownKeys : Object.getOwnPropertySymbols ? ReflectOwnKeys = function ReflectOwnKeys2(target) {
        ...
        Define(o, "_events", void 0);
        Define(o, "_eventsCount", 0);
        Define(o, "_maxListeners", void 0);
        var defaultMaxListeners = 10;
        Define(Object, "defaultMaxListeners", { get: function() {
        ...
        function $getMaxListeners(that) {
          return that._maxListeners === void 0 ? Object.defaultMaxListeners : that._maxListeners;
        }
        ...
        function _addListener(target, type, listener, prepend) {
          ...
          if (existing === void 0) {
            ...
            typeof existing == "function" ? existing = events[type] = prepend ? [listener, existing] : [existing, listener] : prepend ? existing.unshift(listener) : existing.push(listener);
            if ((m = $getMaxListeners(target)) > 0 && existing.length > m && !existing.warned) {
        ...
        function removeListener(type, listener) {
          ...
          if (typeof listener != "function")
            throw new TypeError('The "listener" argument must be of type Function. Received type ' + typeof listener);
          if ((events = this._events) === void 0)
            return this;
          if ((list = events[type]) === void 0)
            return this;
        ...
        function removeAllListeners(type) {
          ...
          if (events.removeListener === void 0) {
            if (arguments.length === 0) {
              ...
              events[type] !== void 0 && (--this._eventsCount == 0 ? this._events = Object.create(null) : delete events[type]);
            return this;
          }
          if (arguments.length === 0) {
            ...
            for (i = 0; i < keys.length; ++i)
              (key = keys[i]) !== "removeListener" && this.removeAllListeners(key);
            this.removeAllListeners("removeListener");
            this._events = Object.create(null);
            this._eventsCount = 0;
            return this;
          }
          if (typeof (listeners2 = events[type]) == "function")
